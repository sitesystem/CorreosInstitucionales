...
dotnet ef dbcontext scaffold ^
	"Server=148.204.211.186;Database=db_Centralizada_UPIICSA;User ID=sa;Password=#Password!!1;Trusted_Connection=False;TrustServerCertificate=True;" ^
	Microsoft.EntityFrameworkCore.SqlServer ^
	--namespace CorreosInstitucionales.Shared.CapaDataAccess.DBContextCentral ^
	--output-dir dbCentral ^
	--data-annotations ^
	--force
