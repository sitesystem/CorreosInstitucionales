...
namespace CorreosInstitucionales.Shared.CapaEntities.Request
{
    ...
    {
        [Required(AllowEmptyStrings = false, ErrorMessage = "Campo NOMBRE DEL ROL requerido.")]
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Campo DESCRIPCIÓN DEL ROL requerido.")]
