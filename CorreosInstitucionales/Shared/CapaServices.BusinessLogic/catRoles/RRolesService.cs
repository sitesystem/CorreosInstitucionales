...
namespace CorreosInstitucionales.Shared.CapaServices.BusinessLogic.catRoles
{
    public class RRolesService(HttpClient httpClient) : IGenericService<RequestViewModel_Rol>
    {
        ...
        public async Task<Response<List<RequestViewModel_Rol>>?> GetAllDataAsync(bool filterByStatus)
        {
        ...
        public async Task<HttpResponseMessage> AddDataAsync(RequestViewModel_Rol oTipoSolicitud)
        {
        ...
        public async Task<HttpResponseMessage> EditDataAsync(RequestViewModel_Rol oTipoSolicitud)
        {
            //var json = JsonSerializer.Serialize(oTipoSolicitud);
            //var content = new StringContent(json, Encoding.UTF8, "application/json");
