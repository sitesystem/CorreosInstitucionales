    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MtTbSolicitudesTicket>(entity =>
        {
            ...
            entity.Property(e => e.SolFechaHoraCreacion)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Fecha Hora de la creación de la Solicitud del Ticket");
            entity.Property(e => e.SolIdEstadoSolicitud)
                .HasDefaultValueSql("((1))")
                .HasComment("FK ID del Estado de la Solicitud (1 = Levantado, 2 = Pendiente, 3 = En Proceso, 4 = Atendido)");
            entity.Property(e => e.SolIdTipoSolicitud)
                .HasDefaultValueSql("((1))")
                .HasComment("FK ID del Tipo de Solicitud (1 - A, 2 - B, 3 - C)");
