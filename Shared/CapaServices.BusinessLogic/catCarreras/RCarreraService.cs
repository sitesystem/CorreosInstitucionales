...
{
    public class RCarreraService : ICarreraService
    {
        private readonly HttpClient _httpClient;
        private readonly JsonSerializerOptions _options = new() { PropertyNameCaseInsensitive = true };
        const string url = "/api/Carreras/";

        public RCarreraService(HttpClient httpClient)
        {
            _httpClient = httpClient;
        }

        public async Task<Response<List<RequestViewModel_Carrera>>?> GetAllDataAsync(bool filterByStatus)
        {
